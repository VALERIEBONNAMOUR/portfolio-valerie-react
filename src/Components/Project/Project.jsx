...
const projects = [
  { name: "Nina Carducci",
    ...
    image: ninaCarducci,
    alt: "Aperçu du site Nina Carducci, photographe",
    tags : ["Lighthouse", "SEO", "Wave"] },
  { name: "Ohmyfood",
     link: "https://valeriebonnamour.github.io/P4-Ohmyfood/", 
     image: ohmyfood,
     alt: "Aperçu du site Ohmyfood, plateforme de réservation de restaurants",
    tags :["HTML", "CSS", "SAS"] },
  { name: "CJA de MAUBEC", 
    link: "https://cjamaubec38.fr/", 
    image: cjaMaubec,
    alt: "Aperçu du site multi-activités sportives et culturelles du CJA de Maubec",
  ...
  { name: "Menu Qwenta", 
    link: "https://www.notion.so/293a5c4e6f44803d994de62f97f6afc9?v=293a5c4e6f448153a137000cbf92b7a4&source=copy_link",
     image: menuQwenta,
     alt: "Aperçu du projet de gestion de menu Qwenta sur Notion",
    tags : ["Notion", "Agile", "Inoreader"] },
  { name: "Print it",
     link: "https://valeriebonnamour.github.io/PROJET-5/", 
     image: printIt,
     alt: "Aperçu du site Print it, imprimerie en ligne",
    tags : ["Javascript", "Dom/Events"] },
  { name: "BV Marketing", 
    image: bvMarketing,
    alt: "Aperçu des différentes réalisations de BV Marketing",
